    ...
    <table>
        ...
        <c:forEach items="${page.items}" var="order">
            <tr>
                ...
                <td><a href="javascript:void(0)" onclick="myOrderItem('${order.orderId}')">查看详情</a></td>
            </tr>
        </c:forEach>
...
<script>
    function myOrderItem(orderId){
        window.location.href = "OrderItemServlet?action=checkOrderItem&orderId="+orderId;
    }
</script>